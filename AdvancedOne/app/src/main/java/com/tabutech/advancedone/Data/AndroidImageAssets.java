package com.tabutech.advancedone.Data;
...
public class AndroidImageAssets {
    ...
    // List for all android me Images
    //broken into heads, body and legs
    ...
    private static final List<Integer> allBodyParts = new ArrayList<Integer>(){{
       addAll(heads);
       addAll(bodies);
       addAll(legs);
    }};
